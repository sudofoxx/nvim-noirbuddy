...
function M.setup(opts)
  ...
  Group.new('LineNr', colors.primary, colors.background)
  Group.new('LineNrAbove', colors.noir_8, colors.background)
  Group.new('LineNrBelow', colors.noir_8, colors.background)
  ...
  Group.new('@tag.builtin', colors.noir_6)
